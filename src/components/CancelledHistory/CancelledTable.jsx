...
const headRows = [
  ...
  // { id: "age", label: "Age" },
  { id: "date", label: "Date" },
  { id: "cancelleddate", label: "Cancelled Date" },

  { id: "cancelledtime", label: "Cancelled Time" }
];
...
export default class CancelledTable extends Component {
  constructor(props) {
    super(props);
    function createData(
      ...
      return {  patient, date, cancelleddate, cancelledtime };
    }
                  ...
                  .map((row, index, item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">{row.cancelleddate}</TableCell>

                        <TableCell align="right">{row.cancelledtime}</TableCell>
                      </TableRow>
                    );
                  })}
              </TableBody>
